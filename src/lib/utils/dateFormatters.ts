...
export interface FormatterOptions {
	...
	timezone?: string;
				 /** Intl locale (e.g. 'en-US' or 'ar-EG-u-nu-arab'). Defaults to 'en-US'. */
				 locale?: string;
}
...
export function createFormatters(options: FormatterOptions = {}) {
				 const { timeFormat = '12h', timezone, locale = 'en-US' } = options;
 ...
 */
export function formatSelectedDate(dateStr: string, locale: string = 'en-US'): string {
