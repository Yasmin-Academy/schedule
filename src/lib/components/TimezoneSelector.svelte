...
<div class="timezone-selector fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-md border rounded-xl shadow-2xl z-50 max-h-[80vh] flex flex-col overflow-hidden">
	<!-- Search -->
	<div class="p-3 border-b border">
		<div class="relative">
			<svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				class="input w-full pl-10 pr-4 py-2 text-sm border rounded-lg focus:ring-2 focus:border-transparent outline-none"
	...
	<!-- Header -->
		<div class="px-4 py-2 border-b border background-secondary">
