...
<table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f9fafb; border-radius: 8px; border: 1px solid #e5e7eb; margin-bottom: 30px;">
	<tr>
		<td style="padding: 24px;">
			...
			${meetingUrl ? `
			<div>
				<div style="color: #6b7280; font-size: 14px; margin-bottom: 4px;">Online Room</div>
				<a href="${meetingUrl}" style="color: ${brandColor}; font-size: 16px; font-weight: 500; text-decoration: none;">Open online room</a>
			</div>
			` : ''}
		</td>
	</tr>
