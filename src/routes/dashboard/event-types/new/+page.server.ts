...
export const actions: Actions = {
	create: async (event) => {
		...
		try {
			...
			await db
				.prepare(
					`INSERT INTO event_types (user_id, name, name_ar, host_name_ar, slug, duration_minutes, description, is_active, cover_image, availability_calendars, invite_calendar, created_at)
