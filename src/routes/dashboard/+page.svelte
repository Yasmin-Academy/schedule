		...
		<div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
			...
			<div class="flex items-center gap-2">
				<input
					type="text"
					readonly
					value={`${data.appUrl}/${data.user.slug}`}
					class="flex-1 px-3 py-2 bg-white border border-blue-300 rounded-md text-sm"
				/>
				<button
					onclick={() => {
						navigator.clipboard.writeText(`${data.appUrl}/${data.user.slug}`);
					}}
			...
			<div class="mt-4 flex flex-wrap gap-2">
				<a href="/dashboard/calendars" class="px-3 py-1.5 bg-white border border-blue-200 rounded-md text-sm hover:bg-blue-100">Calendars</a>
				<a href="/dashboard/calendar" class="px-3 py-1.5 bg-white border border-blue-200 rounded-md text-sm hover:bg-blue-100">Calendar</a>
				<a href="/dashboard/availability" class="px-3 py-1.5 bg-white border border-blue-200 rounded-md text-sm hover:bg-blue-100">Availability</a>
				<a href="/dashboard/emails" class="px-3 py-1.5 bg-white border border-blue-200 rounded-md text-sm hover:bg-blue-100">Emails</a>
				<a href="/dashboard/translations" class="px-3 py-1.5 bg-white border border-blue-200 rounded-md text-sm hover:bg-blue-100">Translations</a>
			</div>
		</div>
