...
<div class="min-h-screen bg-gray-50">
	...
	<header class="bg-white shadow-sm">
		<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
			...
			<a href="/dashboard" class="text-gray-500 hover:text-gray-700" aria-label="Back to dashboard">
						...
						<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
							...
							{#if expandedTemplate === template.template_type}
								<div class="border-t border-gray-200 p-4 bg-gray-50">
									<div class="space-y-4">
										<div>
										<label class="block text-sm font-medium text-gray-700 mb-1" for={`subject-${template.template_type}`}>
												Subject Line
											</label>
											<input
										...
										<div>
										<label class="block text-sm font-medium text-gray-700 mb-1" for={`message-${template.template_type}`}>
												Custom Message (Optional)
											</label>
											<textarea
											id={`message-${template.template_type}`}
