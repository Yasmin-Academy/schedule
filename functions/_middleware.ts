...
export const onRequest: PagesFunction = async (context) => {
	...
	// Allow this origin's static widget assets to be loaded cross-origin (script tag on domain.com)
	...
	if (path.startsWith('/api/availability')) {
		// Do NOT edge-cache availability. We cache in KV and bust immediately via availability revision.
